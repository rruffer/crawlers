package br.com.rruffer.crawlers.application.crawlers.web;
...
public class Crawler4jWebCrawler extends WebCrawler {
    ...
    public boolean shouldVisit(Page page, WebURL url) {
        ...
        LOGGER.log(Level.INFO, "Deve Visitar {0} ? " + deveVisitar, href);
        return deveVisitar;
    }

    @Override
    public void visit(Page page) {
        LOGGER.log(Level.INFO, "Visitando: {0}", page.getWebURL().getURL());
        ...
        if (page.getParseData() instanceof HtmlParseData) {
            ...
            System.out.println("Número de links de saída: " + links.size());
        }
