...
public class GmailOAuth2Service {
    ...
    private static Credential authorize() throws IOException {
        // Load client secrets.
        FileInputStream inputStream = new FileInputStream("D:\\Biblioteca\\Documents\\Projetos\\Projetos Evolutions\\crawlers\\src\\main\\resources\\client_secret.json");
        GoogleClientSecrets clientSecrets
                = GoogleClientSecrets.load(JSON_FACTORY, new InputStreamReader(inputStream/*in*/));
